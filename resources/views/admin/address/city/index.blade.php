...
<x-admin.partials.breadcumb name="City" />
...
<section class="content">
    <div class="row">
        <div class="col-md-8 col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">City List ({{ $cities->total() ?? '0' }}) </h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="">
                        <table class="table mb-0 table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $city->district->division->country->name }}</td>
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-warning" style="margin-right: 3px; border-radius: 4px !important;"
                                                href="{{ route('admin.address.city.edit', $city->id) }}"><i
                                                    class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <form action="{{ route('admin.address.city.delete', $city->id) }}"
        ...
        <div class="col-md-4 col-sm-12">
            @if (empty($cityData) && userCan('address.create'))
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Add City</h4>
                </div>
                <!-- /.box-header -->
                <form class="form" method="post" action="{{ route('admin.address.city.store') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group @error('address_district_id') has-error @enderror">
                            <label>District <span class="color-red">*</span></label>
                            <select name="address_district_id" id="countries" class="form-control">
            ...
            @endif
            <!-- /.box-body -->
            @if (!empty($cityData) && userCan('address.edit'))
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title" style="line-height: 36px;">Update City</h4>
                ...
                <!-- /.box-header -->
                <form class="form" method="post" action="{{ route('admin.address.city.update', $cityData->id) }}">
                    @method('put')
                    @csrf
                    <div class="box-body">
                        <div class="form-group @error('name') has-error @enderror">
                        ...
                        <div class="form-group @error('address_district_id') has-error @enderror">
                            ...
                            <select name="address_district_id" id="countries" class="form-control">
                                <option value="">Select District</option>
                                @foreach ($districts as $district)
                                <option value="{{ $district->id }}" {{ $cityData->address_district_id == $district->id ? 'selected' : ''}}>{{ $district->name }}</option>
                                @endforeach
                            </select>
