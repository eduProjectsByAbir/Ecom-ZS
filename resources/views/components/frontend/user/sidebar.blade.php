...
<ul class="list-group list-group-flush">
    <a href="{{ route('user.home') }}" class="btn {{ Route::is('user.home') || Route::is('user.dashboard') ? 'btn-success' : 'btn-info' }} btn-sm btn-block">Home</a>
    <a href="{{ route('user.myorders') }}" class="btn {{ Route::is('user.myorders') || Route::is('user.myorder.details') ? 'btn-success' : 'btn-info' }} btn-sm btn-block">Orders</a>
