    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                    ...
                    <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
                        <div class="item">
                            <div class="products">
                                <div class="hot-deal-wrapper">
                                    <div class="image"> <img src="{{ asset('frontend') }}/images/hot-deals/p25.jpg"
                                            alt=""> </div>
                        ...
                        <div class="item">
                            <div class="products">
                                <div class="hot-deal-wrapper">
                                    <div class="image"> <img src="{{ asset('frontend') }}/images/hot-deals/p5.jpg"
                                            alt=""> </div>
                        ...
                        <div class="item">
                            <div class="products">
                                <div class="hot-deal-wrapper">
                                    <div class="image"> <img src="{{ asset('frontend') }}/images/hot-deals/p10.jpg"
                                            alt=""> </div>
                                    <div class="sale-offer-tag"><span>35%<br>
                                            off</span></div>
                                    <div class="timing-wrapper">
                ...
                <div class="home-banner"> <img src="{{ asset('frontend') }}/images/banners/LHS-banner.jpg" alt="Image">
                </div>
            </div>
            <!-- /.sidemenu-holder -->
            <!-- ============================================== SIDEBAR : END ============================================== -->
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    <div class="more-info-tab clearfix ">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a data-transition-type="backSlide" href="#catid{{ $category->id }}" data-toggle="tab">{{ $category->name }}</a>
                            </li>
                            @if ($loop->index == 4)
                                @break
                            @endif
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a href="detail.html"><img
                                                    src="{{ $featured_product->product_thumbnail_url }}"
                                                    alt=""></a> </div>
                                        <!-- /.image -->
                                        @if($featured_product->discount_price !== null)
                                        <div class="tag sale"><span>{{ round(($featured_product->discount_price/$featured_product->price)*100) }}%</span></div>
                                        @else
                                        @if($product->hot_deals == 1)
                                        <div class="tag hot"><span>hot</span></div>
                                        @else
                                    ...
                                    <div class="product-info text-left">
                                        ...
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                                        <div class="product-price"> <span class="price"> ${{ $featured_product->discount_price !== null ? ($featured_product->price - $featured_product->discount_price) : $featured_product->price  ?? $featured_product->price }} </span>
                                            @if($featured_product->discount_price !== null)
