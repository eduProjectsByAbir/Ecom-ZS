        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <a href="" class="btn btn-warning btn-sm btn-block">Change Password</a>
            ...
            <div class="col-md-8">
                <div class="card">
                    <h3 class="text-center"><span class="text-danger">Hi...</span><strong>{{ Auth::user()->name }}</strong> Welcome to e-commerce sh op</h3>
                </div>
            </div>
        </div>
    </div>
